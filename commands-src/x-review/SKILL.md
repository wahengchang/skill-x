...
orchestration, while adding risk-adaptive depth and delta-scoped quick re-review.
Full review preserves the strict consumer tracing and final-content discipline;
quick review deliberately avoids repository-wide exploration unless it must
escalate.
